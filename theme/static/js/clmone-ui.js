...
(function () {
  ...
  var CLMOne = window.CLMOne = window.CLMOne || {};

  CLMOne.chartTheme = Object.freeze({
  ...
  CLMOne.dataTable = Object.freeze({
  ...
  CLMOne.toast = function (message, options) {
    options = options || {};
    var region = document.getElementById('clmone-toast-region');
  ...
  document.addEventListener('click', function (event) {
    ...
    if (!trigger) return;
    CLMOne.toast(trigger.getAttribute('data-toast-message'), {
      tone: trigger.getAttribute('data-toast-tone') || 'info'
    });
  });

  function initCommandPalette() {
    var dialog = document.getElementById('clmone-command-palette');
    ...
    CLMOne.commandPalette = { open: open, close: close };
  }

  function initServerToasts() {
    document.querySelectorAll('[data-server-toast]').forEach(function (message) {
      CLMOne.toast(message.getAttribute('data-toast-message'), {
