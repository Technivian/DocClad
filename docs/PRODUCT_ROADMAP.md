...
**Companion docs:** Engineering delivery waves live in [`ROADMAP.md`](../ROADMAP.md). This document owns product boundaries, sequencing, and acceptance outcomes.
...
- [ ] Audit every destination against the product map above
- [ ] Remove or redirect duplicate personal queues (dashboard “Waiting on Me”, Command Center “My Queue” as personal inbox)
- [ ] Fix naming drift (e.g. dashboard / hub labels that still say “My work”)
- [ ] Document the canonical route for each job-to-be-done
...
- [ ] My Work becomes a **view** over that model
- [ ] Command Center becomes an **org-wide view** over the same model
