...
**Status:** **In progress** — ADR-0015 **Accepted**; foundation PR #66 **merged** (`982b0900`); dual-write PR #69 **merged** (`f19eae42`, default-off); controlled-pilot dual-write Motion 3 **Authorized** (`2026-07-22T20:04:34Z`); committed flag defaults remain **off**; canonical read cutover **unauthorized**  
...
**Activation:** Motion 3 **Authorized** — [`CONTROLLED_PILOT_DUAL_WRITE.md`](CONTROLLED_PILOT_DUAL_WRITE.md)  
...
| [`CONTROLLED_PILOT_DUAL_WRITE.md`](CONTROLLED_PILOT_DUAL_WRITE.md) | Motion 3 activation package (**Authorized**; committed defaults off) |
...
| [`CONTROLLED_PILOT_DUAL_WRITE.md`](CONTROLLED_PILOT_DUAL_WRITE.md) | Pilot activation package (**Motion 3 Authorized**; operational enablement next) |
...
| Controlled-pilot activation authorization (Motion 3) | **Met** (`2026-07-22T20:04:34Z`) |
| Controlled-pilot operational enablement + monitoring evidence | **Authorized**; not yet executed (committed defaults remain off) |
