...
**Status:** **In progress** — canonical authority **implemented** (default off); activation **pending**; remediation package merged; R0 inventory **PASS**; R1+ pending; legacy retained; ADMIN deferred; **GI-2026-07-22-PR58-PREAUTH-MERGE Ratified and Closed**  
...
| [`../2026-07-22-par-id-001-remediation-decision/INDEX.md`](../2026-07-22-par-id-001-remediation-decision/INDEX.md) | Remediation decision package + R0 exit (**PASS**; verified 20/4/8) |
