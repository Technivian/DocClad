...
|theme/templates/contracts/obligations_list.html|QueuePage|QueuePage|Medium|Record-oriented page with list/table/filter behavior|Mixed utility and canonical primitives may coexist|Medium|**DEFERRED** Batch 6 Step 10 — CLASS D: JS prototype. All content JS-driven (no Django template vars in list/grid, onClick populated). No safe Django template migration possible without JS rewrite. Defer until JS refactor.|
...
|theme/templates/contracts/templates_list.html|QueuePage|QueuePage|Medium|Record-oriented page with list/table/filter behavior|Mixed utility and canonical primitives may coexist|Medium|**DEFERRED** Batch 6 Step 10 — CLASS D: JS prototype. All content JS-driven (no Django template vars rendered in list/grid). No safe Django template migration possible without JS rewrite. Defer until JS refactor.|
