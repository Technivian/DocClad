...
|theme/templates/contracts/contract_list.html|QueuePage|QueuePage|Medium|Record-oriented page with list/table/filter behavior|Mixed utility and canonical primitives may coexist|Medium|Low|Canonical QueuePage wrappers available|
...
|theme/templates/contracts/identity_telemetry_dashboard.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|Medium|Workspace panel/header conventions and state patterns|
...
|theme/templates/contracts/reports_dashboard.html|WorkspacePage|WorkspacePage|Medium|Context-rich page combining panels/details/actions|Panel density and secondary actions vary|High|Medium|Workspace panel/header conventions and state patterns|
